...
// import VueMappForm from './form/component.vue';
// import VueMappField from './field/component.vue';
import VueMappForm from './form/form.vue';
import VueMappField from './field/field.vue';
...
export default class InputElement extends Vue {
  ...
  get status(): VMInputState {
    ...
    const status =
      (field && field.status) || (form && form.status) || injectStatus;
